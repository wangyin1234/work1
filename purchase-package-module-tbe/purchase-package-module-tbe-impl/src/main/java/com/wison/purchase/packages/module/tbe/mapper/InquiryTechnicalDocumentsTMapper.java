...
/**
 * (inquiry_technical_documents_t)数据Mapper
 *
 * @author yinxin
 * @description 自动创建
 ...
 */
@Mapper
public interface InquiryTechnicalDocumentsTMapper extends BaseMapperPlus<InquiryTechnicalDocumentsT, InquiryTechnicalDocumentsT> {
