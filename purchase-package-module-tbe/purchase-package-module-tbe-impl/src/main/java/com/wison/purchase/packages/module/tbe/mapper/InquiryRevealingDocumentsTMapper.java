...
/**
 * 询价商务文件表(inquiry_revealing_documents_t)数据Mapper
 *
 * @author yinxin
 * @description 自动创建
 ...
 */
@Mapper
public interface InquiryRevealingDocumentsTMapper extends BaseMapperPlus<InquiryRevealingDocumentsT, InquiryRevealingDocumentsT> {
